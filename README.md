...
void key()
{
	...
	lcd = Lcd_create(ports, pins, GPIOB, GPIO_PIN_0, GPIOB, GPIO_PIN_1, 
 LCD_4_BIT_MODE);
...
## Output screen shots of proteus  :
 ...
 ![Screenshot 2025-04-25 144446](https://github.com/user-attachments/assets/f3df90fb-b2b9-4875-8024-08d4d5301e88)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 [pmc ex5 proteus.pdf](https://github.com/user-attachments/files/19906066/pmc.ex5.proteus.pdf)
